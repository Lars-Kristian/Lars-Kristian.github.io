...
"use strict";
/* unused harmony export isKeyPress */
/* harmony export (immutable) */ __webpack_exports__["c"] = isKeyDown;
/* harmony export (immutable) */ __webpack_exports__["d"] = isKeyUp;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = addToScene;
...
function doStuff() {
  ...
  `;
	...
	uniforms = {
		texture: {
			value: __WEBPACK_IMPORTED_MODULE_1__store_js__["a" /* store */].texture.test
		},
		threshold: {
			value: 0.4
		},
		myColor: {
			value: new __WEBPACK_IMPORTED_MODULE_0_three__["Vector4"](0, 1, 0, 1)
		}
	};
...
function loadFont(name, data) {
	...
	fonts[name] = parsedData;
	var font = fonts[name];

	createMesh(parsedData);


	font.materialb = new __WEBPACK_IMPORTED_MODULE_0_three__["MeshBasicMaterial"]({
		//map: texture,
		wireframe: true
	});


	font.material = new __WEBPACK_IMPORTED_MODULE_0_three__["ShaderMaterial"]({
		uniforms: uniforms,
...
"!\`?'.,;:()[]{}<>|/@\^$-%+=#_&~*`;
	var scale = 1;
	var moveX = getWidth("default", theString);
	moveX = moveX / 2 * scale;
	font.testb = new __WEBPACK_IMPORTED_MODULE_0_three__["Mesh"](getMesh("default", theString), font.materialb);
	font.testb.position.set(-moveX, -10, 0);
	font.testb.scale.set(scale, scale, scale);


	font.test = new __WEBPACK_IMPORTED_MODULE_0_three__["Mesh"](getMesh("default", theString), font.material);
	font.test.position.set(-moveX, -10, 0);
	font.test.scale.set(scale, scale, scale);
...
function addToScene(scene) {
	scene.add(fonts.default.test);
	//scene.add(fonts.default.testb);
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_three__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__engineMath_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__forceGraph_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__planet_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__star_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__debug_js__ = __webpack_require__(2);
...
Level.prototype = Object.assign(Object.create(Object.prototype), {
	...
	debug: function() {
		...
		__WEBPACK_IMPORTED_MODULE_5__debug_js__["d" /* debug */].drawCircle(this.center.x, this.center.y, this.radius);

		__WEBPACK_IMPORTED_MODULE_5__debug_js__["d" /* debug */].drawDot(this.entry.x, this.entry.y);
		var test = new __WEBPACK_IMPORTED_MODULE_0_three__["Vector2"]();
		test.addVectors(this.entryDirection, this.entry);
		__WEBPACK_IMPORTED_MODULE_5__debug_js__["d" /* debug */].drawLine(this.entry.x, this.entry.y, test.x, test.y);
	}
});

/*

void spawnLevel(level* l) {
	if (l->state != levelState::ready) { return; }

	l->starHeight = getRandomFloat(1, 2);
	int numStars = getRandomInt(l->numPlanets - 1, l->numPlanets + 2);
	...
	for (int i = 0; i < numStars; i++) {
		...
		if (s) {
			...
			do {
				planet* p = getRandomPlanet(l);
				float segmentAngle = 2 * pi / 4;
				float angle = segmentAngle * getRandomInt(0, 4);
				up = { 0.0f, 1.0f, 0.0f };
				Vector3::rotateX(&up, angle);
				Vector3::multiply(&up, &up, (p->radius + l->starHeight));
				Vector3::add(&up, &up, &p->position);
				Vector3::set(&s->position, &up);
			} while (isCollidingPlanet(&up, l->starHeight, l));
		}
	}
	l->numStars = numStars;
	...
	planet* p = getRandomPlanet(l);
	float segmentAngle = 2 * pi / 6;
	float angle = segmentAngle * getRandomInt(0, 4);
	vector3 up = { 0.0f, 1.0f, 0.0f };
	vector3 direction;
	Vector3::rotateX(&up, angle);
	Vector3::set(&direction, up.y, -up.x, 0);
	Vector3::normalize(&direction);
	Vector3::multiply(&up, &up, (p->radius + l->starHeight));
	Vector3::add(&up, &up, &p->position);

	if (getRandomFloat(0, 1) > 0.5f) {
		Vector3::multiply(&direction, &direction, -1.0f);
	}

	vector3 result;
	Vector3::add(&result, &up, &direction);
	Debug::drawLine(&up, &result);

	vector3 entry = { 0, 0, 0 };
	getEntryIntersection(&entry, &up, &result, &l->levelCenter, l->levelRadius);

	Vector3::add(&result, &entry, &direction);

	Debug::drawLine(&entry, &result);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_three__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__keyboard__ = __webpack_require__(4);
...
Ship.prototype = Object.assign(Object.create(__WEBPACK_IMPORTED_MODULE_0_three__["Mesh"].prototype), {
	...
	simulate: function(level, dt) {
		if (this.planet != null) {
			__WEBPACK_IMPORTED_MODULE_3__debug_js__["d" /* debug */].drawDot(this.planet.position.x, this.planet.position.y);
		}

		switch (this.state) {
			case 'stop':
				if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__keyboard__["c" /* isKeyDown */])(32)) {
					this.state = 'run';
				}
				break;
			case 'run':
				...
				break;
			case 'preOrbit':
				if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__keyboard__["d" /* isKeyUp */])(32)) {
					this.state = 'run';
				}
				break;
			case 'orbit':
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_three__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__engineMath_js__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_three__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utility_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_sui_fnt__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_sui_fnt___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__data_sui_fnt__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fontParser_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ship_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__target_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__planet_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__star_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__keyboard_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__forceGraph_js__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__debug_js__ = __webpack_require__(2);
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utility_js__["a" /* loadUriTexture */])(__WEBPACK_IMPORTED_MODULE_12__store_js__["a" /* store */].texture, 'test', __WEBPACK_IMPORTED_MODULE_2__data_js__["a" /* fontTexture */]);
console.log(__WEBPACK_IMPORTED_MODULE_12__store_js__["a" /* store */]);
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__fontParser_js__["a" /* loadFont */])('default', __WEBPACK_IMPORTED_MODULE_3__data_sui_fnt___default.a);
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__ship_js__["a" /* addShipToStore */])(__WEBPACK_IMPORTED_MODULE_12__store_js__["a" /* store */]);
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__planet_js__["a" /* addPlanetToStore */])(__WEBPACK_IMPORTED_MODULE_12__store_js__["a" /* store */]);
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13__debug_js__["a" /* addDebugToStore */])(__WEBPACK_IMPORTED_MODULE_12__store_js__["a" /* store */]);
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__star_js__["a" /* addStarToStore */])(__WEBPACK_IMPORTED_MODULE_12__store_js__["a" /* store */]);
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__target_js__["a" /* addTargetToStore */])(__WEBPACK_IMPORTED_MODULE_12__store_js__["a" /* store */]);

__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13__debug_js__["b" /* initDebug */])(scene);
...
var ship = new __WEBPACK_IMPORTED_MODULE_5__ship_js__["b" /* Ship */]();
var star = new __WEBPACK_IMPORTED_MODULE_8__star_js__["b" /* Star */]();
var target = new __WEBPACK_IMPORTED_MODULE_6__target_js__["b" /* Target */]();
scene.add(target);
...
function init() {
	...
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__fontParser_js__["b" /* addToScene */])(scene);
...
function animate() {
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13__debug_js__["c" /* resetDebug */])();
	...
	*/
	...
	/*
	if (isKeyPress(32)) {
		console.log('isKeyPress: space');
	}

	if (isKeyDown(32)) {
		console.log('isKeyDown: space');
	}

	if (isKeyUp(32)) {
		console.log('isKeyUp: space');
	}*/
